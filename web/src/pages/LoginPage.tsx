    ...
    <div class="login-page">
      <div class="login-card">
        ...
        <p style={{ color: '#94a3b8', marginBottom: 24, textAlign: 'center' }}>
          Remote control your AI coding agents
        </p>
        <button class="btn btn-primary" style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }} onClick={handleGithub}>
